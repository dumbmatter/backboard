...
module.exports = (event, schemas) => {
    ...
    schemas.forEach(function (schema) {
        ...
        Object.keys(prevObjectStores).forEach(function (objectStore) {
        ...
        Object.keys(objectStores).forEach(function (objectStore) {
            ...
            Object.keys(prevIndexes).forEach(function (index) {
